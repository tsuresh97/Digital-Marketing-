...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <address>
               <strong>Thanjavur Veenai Worker</strong><br>
                No. 528, East Gate Street,<br>
                Thanjavur-613001<br>
                <abbr title="Phone">
                    P:</abbr>
                (+91) 97501 63636
            ...
            <address>
                <strong>Mr.V.Chinnappa</strong><br>
                <a href="mailto:#">veenaichinnappa@gmail.com</a><br><br><br><br><br><br>
            </address>
            </form>
        </div>
    </div>
